...
While all your character creation decisions bear narrative weight, none influences the way you play the game like your choice of class. Your class determines how your hero battles the threats of the timescape and overcomes other obstacles. Your class provides you with many of your features, most of your abilities -- your most potent combat moves and noncombat options -- and a Heroic Resource that fuels many of those abilities.

This book presents nine classes to choose from. Each class also has a number of subclasses. Your subclass determines many of your hero's abilities and features, and further defines how you interact with the world from 1st level on.

## The Nine Classes

| Class | Heroic Resource | Description |
|---|---|---|
| **Censor** | Wrath | A trained warrior devoted to a saint or god who hunts down the forces of evil using melee weapons and magic, specializing in confronting the wicked and locking down single enemies during combat. |
| **Conduit** | Piety | The devoted priest of a saint or god who wields divine magic that smites enemies with holy energy, supports their allies, and is renowned for their healing abilities. |
| **Elementalist** | Essence | Studies the elemental forces of the timescape and controls earth, fire, the void, and more with magic. Has a versatile array of tricks for both controlling combat and manipulating the environment. |
| **Fury** | Ferocity | Coursing with the ferocity of the Primordial Chaos, a mobile warrior who gets up close and personal with enemies to dish out lots of damage, leaping around the battlefield felling foes and breaking down walls. |
| **Null** | Discipline | Disciplined and calm, an unarmed warrior who manifests an aura that quells the supernatural and hinders the offensive prowess of enemies. Uses psionics to make their body stronger than any steel and faster than any steed. |
| **Shadow** | Insight | An expert assassin and thief who fights equally well in melee and at range, getting the drop on foes. Utilizes magic to stay mobile on the battlefield and sneak up on prey. |
| **Tactician** | Focus | A brilliant strategist and weapons master who excels at granting allies more movement and actions on the battlefield. Also supports allies outside of combat, inspiring friends to greatness. |
| **Talent** | Clarity | The master of psionics, manifesting powers that manipulate objects, minds, and time. Can reach far into themselves to use abilities even when they don't have Heroic Resource to spare -- if they're willing to face the cost. |
| **Troubadour** | Drama | Inspires allies with storytelling and swordplay that is as much an art as it is an act of war. Quips, songs, poems, and epic tales produce actual magic that harms foes and bolsters allies, and can even tweak the campaign's story in real time. |
...
Abilities are special actions, maneuvers, and more that allow you to affect creatures, objects, and the environment. They represent the main activities your character can undertake when the game is in combat or some other time-sensitive scenario. All characters have access to a few basic abilities, including free strikes and maneuvers such as Grab and Knockback. But your class, ancestry, kit, titles, and treasures give you access to more powerful abilities that make your hero stand out.
...
> **Abilities in Combat:** All abilities appearing in this book are used as a main action, a maneuver, a triggered action, or some other part of your turn. As such, these abilities are all explicitly usable in combat or some other time-sensitive scenario where the game unfolds as combat rounds. If a creature has an ability that takes 1 minute or longer to use, that ability can't be used in combat.
...
Each class grants a variety of features at various levels. Features are passive benefits or special rules that are always active (unless stated otherwise). They don't typically require spending actions or resources to use.

## Ability Format

### Name and Story Text

Each ability has an evocative name that sets up what it does in the game, followed by a line or two of flavor text that provides a sense of how the ability might appear if described in an action scene in a story. Narrative flavor has no effect on how an ability can be used.

### Keywords

Each ability has one or more keywords that explain how the ability functions. Keywords appear in the first line of the ability beneath the flavor text, on the left side. An ability with no keywords is noted as "--."

- **Area:** The ability creates an area of effect. Many area abilities deal damage to targets in their area, but are treated differently than strikes made against specific targets.
- **Charge:** The ability can be used with the Charge main action instead of a melee free strike.
- **Magic:** The ability is used by characters who can cast spells, have innate magical features, or wield magic treasures. Such abilities do magical things such as create rays of fire, open swirling portals, or summon creatures.
- **Melee:** The ability can be used only over very short distances, typically within a character's reach, because it requires a character to make contact with a creature or object with their body, a weapon, or an implement.
- **Psionic:** The ability is used by characters who can manifest psionic powers, have innate psionic features, or wield psionic items. These abilities might create blasts of psychic energy, move objects with telekinesis, or slow down time with chronopathy.
- **Ranged:** The ability can be used to affect creatures who are too far away to make contact with.
- **Strike:** The ability (often referred to simply as "strikes") deals damage to or imposes a harmful effect on specific creatures or objects. The Strike keyword is reserved for abilities that target specific creatures or objects (not areas) and harm those targets by making a power roll.
- **Weapon:** The ability must be used with a blade, a bow, or some other offensive weapon. Weapon abilities also include strikes creatures make with their own bodies, such as unarmed strikes or a monster's punches, kicks, bites, tail slaps, and more.

### Type

Each ability notes the type of activity required to use it, on the right side of the first line beneath the flavor text. Most abilities require you to use a main action, a maneuver, a move action, a triggered action, a free maneuver, or a free triggered action.
...
Melee abilities have a distance of "Melee X" and require you to make contact with a creature or object with your body, a weapon, or an implement. The number X is the maximum distance in squares at which you can physically make contact with another creature or object targeted by the ability. For instance, "Melee 1" limits you to adjacent targets (those within 1 square).

#### Ranged

Ranged abilities have a distance of "Ranged X" and can be used to target creatures or objects within X squares of you. If you make a ranged strike while any enemy is adjacent to you (within 1 square), you have a bane on the strike's power roll.

#### Melee or Ranged

Some abilities have a melee distance and a ranged distance. When you use such an ability, you choose whether to use it as a melee or ranged ability. An ability never has both the Melee and Ranged keywords at the same time.
...
Area abilities cover a number of squares on the battlefield at once, creating an effect within that area that lets you target multiple creatures or objects. Area types include:

- **Aura:** "X aura." The radius of the aura, which always originates from you and moves with you for the duration.
- **Burst:** "X burst." The radius of the burst, which always originates from you and lasts only for as long as it takes to affect its targets.
- **Cube:** "X cube." A cubic area where X is the length of each side in squares. A creature or object must be within the area to be targeted.
- **Line:** "A x B line." A linear area where A is the line's length in squares and B is the width and height. Squares in the line must be in a straight line.
- **Wall:** "X wall." X is how many squares are used to make the wall. Each square must share at least one side (not just a corner) with another square of the wall.

### Target

The "Target" entry notes the number of creatures, objects, or both who can be targeted by the ability. You can always affect fewer targets than the number indicated. Target types include:

- **Creature:** One or more creatures within the ability's distance or area.
- **Object:** One or more objects within the ability's distance or area. Objects have poison immunity and psychic immunity.
- **Enemy:** Only creatures who are hostile to the creature using the ability.
- **Ally:** Only willing creatures who are friendly to the creature using the ability. You aren't an eligible target for your own abilities that target allies unless those abilities also have "self" as a target.
- **Self:** Only the creature using the ability.
...
If an ability requires a power roll, it has a "Power Roll" entry that tells you which characteristic to add to the 2d10 roll you make when you use the ability. Unlike power rolls made as tests, ability rolls always do something useful -- you're rolling to determine the impact of the ability, including how much damage it deals and any other effects it imposes based on the tier outcome of the power roll.

The three tiers are:

- **Tier 1 (11 or lower):** The weakest outcome, but still does something.
- **Tier 2 (12-16):** A moderate result.
- **Tier 3 (17 or higher):** The strongest outcome.

## Damage Notation

Certain damage-dealing abilities note their damage as a number followed by a plus sign (+) and one of the following letters, representing a characteristic score added to the damage:
...
For example, "3 + M damage" means the ability deals 3 plus your Might score in damage. Some abilities let you use your highest characteristic score for the power roll, using a format similar to "7 + M or A damage."
...
Many abilities and other effects impose conditions and unique statuses on targets. But creatures sometimes get a chance to resist such effects.
...
- **Weak potency** = your highest characteristic score - 2
- **Average potency** = your highest characteristic score - 1
- **Strong potency** = your highest characteristic score

In abilities and other effects, a potency always appears as the single-letter abbreviation for the target's characteristic: **M** for Might, **A** for Agility, **R** for Reason, **I** for Intuition, or **P** for Presence. That characteristic is followed by a "less than" sign (<) and your potency value -- for example, **M < WEAK** or **R < AVERAGE** -- with the value indicating the minimum score in that characteristic the target needs to beat the effect.
...
Potencies are made for quick resolution at the table, but a number of triggered actions and other abilities -- for example, the censor's Judgment ability and the null's Null Field ability -- allow you to manipulate the value of potencies.
...
- **Extra Damage:** Whenever you deal rolled damage, you can spend up to 3 surges to deal extra damage to one creature or object targeted by the ability. Each surge you spend deals extra damage equal to your highest characteristic score.
- **Boost Potency:** Whenever you target one or more creatures with an ability that has a potency, you can spend 2 surges to increase the potency by 1 for one target. You can't increase a potency by more than 1 using surges, though you can spend additional surges to increase the potency for multiple targets.
...
When an ability has multiple targets (whether a strike with more than one target or an area effect), you make one power roll and apply the total to all targets. If you have edges or banes, you might apply a different tier outcome to individual targets.

## Ending Effects

When a creature suffers a lasting effect, the effect specifies how long it lasts. Unless otherwise noted, all effects and conditions imposed on heroes during a combat encounter end when the encounter is over, except for being winded, unconscious, or dying.
...
If an effect has "(save ends)" at the end of its description, a creature suffering the effect makes a saving throw at the end of each of their turns to try to remove the effect. A saving throw represents the sheer luck involved in shaking off an effect.
...
Different effects that impose the same condition don't stack to impose the condition twice.
...
You take damage from this condition when you use an action off your turn. For example, a signature ability used as a free triggered action with the assistance of the tactician's Strike Now ability triggers the damage from the bleeding condition.
...
When a creature is frightened, any ability roll they make against the source of their fear takes a bane. If that source is a creature, their ability rolls made against the frightened creature gain an edge. A frightened creature can't willingly move closer to the source of their fear if they know the location of that source. If a creature gains the frightened condition from a different source while already frightened, the new condition replaces the old one.

### Grabbed

A creature who is grabbed has speed 0, can't be force moved except by a creature, object, or effect that has them grabbed, can't use the Knockback maneuver, and takes a bane on abilities that don't target the creature, object, or effect that has them grabbed. If the creature that grabbed them moves, they bring the grabbed creature with them. A creature can grab only creatures of their size or smaller (or larger if their Might is 2 or higher). Only one creature can be grabbed at a time unless otherwise indicated.
...
A creature who is restrained has speed 0, can't use the Stand Up maneuver, and can't be force moved. A restrained creature takes a bane on ability rolls and on Might and Agility tests, and abilities used against them gain an edge. If a creature teleports while restrained, that condition ends.
...
A creature who is taunted has a double bane on ability rolls for any ability that doesn't target the creature who taunted them, as long as they have line of effect to that creature. If a creature gains the taunted condition from a different source while already taunted, the new condition replaces the old one.
...
Each class in this chapter includes a table that shows the progression as a hero gains new levels in that class. Each of those tables has an Abilities column that shows abilities granted by the hero's subclass, tracking all heroic abilities a hero of that class has at each level. Each ability is represented by a numeral noting the ability's Heroic Resource cost.
...
As heroes earn Victories and convert them to experience points (XP), they gain levels and unlock new features, abilities, and improvements. Each class has an advancement table showing what is gained at each level from 1st through 10th. Common level-up benefits include:

- **Characteristic Increases:** At certain levels, your characteristic scores increase, improving your damage, potencies, and ability rolls.
- **New Abilities:** You gain access to higher-cost heroic abilities as you level up, giving you more powerful options in combat.
- **Perk:** You gain a perk of your choice from available categories (interpersonal, lore, crafting, exploration, or supernatural).
- **Skill Increase:** You gain an additional skill of your choice.
- **Subclass Features:** Your subclass grants additional features and abilities at various levels.

## Kits

Each class has access to a kit, which you choose at 1st level. A kit represents specialized training, fighting style, or equipment loadout that further customizes your hero. Kits provide benefits such as:

- Weapon proficiencies and bonuses
- Armor and shield options
- Bonus damage to melee, ranged, or magic abilities
- Stamina bonuses
- Speed bonuses
- Special abilities unique to the kit

Kits are detailed in Chapter 6: Kits. Your character's kit determines the types of weapons you wield and use with your weapon abilities. You can change your kit when you finish a respite, allowing you to adapt your playstyle as the campaign progresses.
...
As a censor, you are at your best against the strongest foes. Your judgment terrifies heretics, stops enemies in their tracks, and even hurls them across the battlefield.

---

### Basics

- **Starting Characteristics**: Might 2, Presence 2, plus one of the following arrays for other scores:
  - 2, -1, -1
  - 1, 1, -1
  - 1, 0, 0
...
### Subclass: Censor Order

Censors are the will of their god made physically manifest. You choose a censor order, each of which grants you a skill. (*Quick Build*: Paragon.)
...
Your censor order is your subclass, and your choice of order determines many of the features you gain as you gain new levels.

---

### Deity and Domains

Choose a god or saint who your character reveres. With the Director's permission, you can also create your own deity and choose four domains to be part of their portfolio.

After choosing your deity, pick one domain from their portfolio. Your choice of domain determines many of the features you gain from this class. (*Quick Build*: Cavall as deity and War as domain.)
...
Additionally, the first time each combat round that a creature judged by you (see Judgment) deals damage to you, you gain 1 wrath. The first time each combat round that you deal damage to a creature judged by you, you gain 1 wrath.
...
**Effect:** The target is judged by you until the end of the encounter. If you use this ability again, you willingly end this effect (no action required), or another censor judges the target.
...
When a creature judged by you is reduced to 0 Stamina, you can use this free triggered action to use the ability against a new target.
...
**Judgment Order Benefit:** The first time on a turn that you use your Judgment ability to judge a creature, you gain the following benefit based on your order:
...
You can interpret diagrams and charts even if you don't understand the language associated with them. You are considered fluent in all languages for the purpose of understanding the project source for any crafting or research project.
...
- **Clear**: Edge on tests that use the Search or Navigate skills.
- **Foggy**: Edge on tests that use the Hide skill.
- **Overcast**: Edge on tests that use the Endurance skill.
...
Each time you finish a respite, you can choose yourself or one ally who is also finishing a respite to gain the benefit of a divine ritual.
...
##### Light of Revelation
As a maneuver, your body shine brightly, illuminating your space and each square within 5 squares until you dismiss the light (no action required). This light shines through any darkness. Hidden creatures in the area are automatically revealed, and creatures in the light, including you, can't hide. While this feature is active, you gain an edge on tests made to notice hidden objects and entrances and to detect supernatural illusions.
...
##### Saint's Epiphany
At a start of a respite, you can inspire yourself or another creature taking the same respite with divine knowledge. If the target makes a project roll during this respite, they can add 1d10 plus your Presence score to the roll.
...
- **Starting Characteristics**: Intuition 2; choose one array for remaining scores:
  - 2, 2, -1, -1
  - 2, 1, 1, -1
  - 2, 1, 0, 0
  - 1, 1, 1, 0
...
After choosing your deity, pick two domains from their portfolio. The two domains you pick make up your subclass, and your choice of domains determines many of the features you'll gain as you gain new levels. *(Quick Build: Adun for deity, and Life and Protection as domains.)*
...
- **If the roll is a 3**: You gain 2 additional piety and can activate a domain effect of your choice (see Domain Piety and Effects below).
...
Your choice of domains provides you with two additional ways to earn piety during combat, as triggered by specific events. You might even have a single event trigger both your piety effects. Additionally, whenever you activate a domain effect by praying for piety, you can choose one of your domains and have that domain's prayer effect take effect immediately.
...
- **Prayer Effect**: Choose yourself or one ally within 10 squares. That character can spend a Recovery, can end one effect on them that is ended by a saving throw or that ends at the end of their turn, and can stand up if they are prone. Alternatively, you or one ally within 10 squares gains temporary Stamina equal to two times your Intuition score.
...
You gain a domain feature from your domain, as shown on the 1st-Level Conduit Domain Features table. Additionally, you gain a skill from your domain, selected from the skill group indicated on the table. *(Quick Build: Revitalizing Ritual and the Heal skill from the Life domain.)*
...
You have the following ability, which can be used once on your turn.
...
Your god grants you a ward that protects you from the faithless. Choose one of the following wards. You can change your ward along with your prayer by praying to your god as a respite activity. *(Quick Build: Bastion Ward.)*
...
In response to a foe's aggression, your god protects you. Whenever another creature damages you, that creature can't target you with a strike until they harm you or one of your allies, or until the end of their next turn.
...
**Effect:** Until the end of the encounter or until the target is dying, at the start of each of the target's turns, they gain a bonus to speed and a bonus to rolled damage equal to the number of allies within 10 squares of them. The bonus lasts until the start of their next turn.

#### Reap (5 Piety)
*The gods reward those who smite your foes.*
- **Keywords**: Magic, Ranged
- **Type**: Maneuver
- **Distance**: Ranged 10
- **Target**: Each ally
...
You gain the 1st-level domain feature and ability to choose a skill for the domain you selected at 1st level but whose feature you didn't take at that level.
...
At a start of a respite, you can inspire yourself or another creature taking the same respite with divine knowledge. If the target makes a project roll during this respite, they can add 1d10 plus your Intuition score to the roll.
...
As a main action, you touch a living tree and make it a part of a divine transportation network. You can maintain a number of trees in your network equal to your Intuition score. Whenever you touch any tree in your network, you can use a main action to teleport yourself and any willing creatures within 10 squares of you to a tree in your network on the same world. If a tree in your network dies, it is no longer part of the network. You can remove a tree from your network no matter your distance from it, including across different worlds (no action required).
...
Choose one of your domains. You gain a domain feature from your domain, as shown on the 7th-Level Conduit Domain Features table.
...
While you rest in their presence, your god might also give you priority targets to enact justice upon. You and your allies each have a double edge on power rolls made against such priority targets. If you attempt to open a portal to your deity again before you have defeated your priority targets, you suffer your god's wrath, as determined by the Director.
...
Additionally, you can spend divine power as if it were piety to use any conduit abilities you don't have, as the gods answer your prayers with temporary and unique gifts. If you use a conduit ability you don't have that normally costs no piety, you must spend 1 divine power to use it.
...
- **Starting Characteristics**: Reason 2, then choose one array for other scores:
  - 2, 2, -1, -1
  - 2, 1, 1, -1
  - 2, 1, 0, 0
  - 1, 1, 1, 0
...
- **Stamina Gained at 2nd and Higher Levels**: 6
- **Recoveries**: 8
- **Skills**: You gain the Magic skill. Then choose any three skills from the crafting or lore skill groups. *(Quick Build: Alchemy, Blacksmithing, History, Magic.)*
...
| 9th | Grand Wyrding, New 11-Essence Ability | Two signature, 3, 5, 5, 7, 9, 9, 11, 11 |
| 10th | Characteristic Increase, Breath, Essential Being, One, Perk, Skill Increase | Two signature, 3, 5, 5, 7, 9, 9, 11, 11 |
...
- **Air** is the element of movement. Air abilities manipulate speed, quickness, flight, and breath.
...
You choose an elemental specialization from the following options: **earth, fire, green, or void**. Your elemental specialization is your subclass. *(Other elemental specializations will be featured in future products.)* *(Quick Build: Fire.)*
...
You become an expert at wielding destructive flames. Your abilities that have the Fire and Magic keywords gain a +1 bonus to rolled damage. Your Hurl Element ability also gains this bonus when you use it to deal fire damage.
...
Some of your heroic abilities have a persistent effect entry. For example, Instantaneous Excavation has an effect noted as "Persistent 1." Whenever you use a persistent ability, you decide whether you want to maintain it, and start doing so immediately after you first use the ability. If you maintain a persistent ability in combat, you reduce the amount of essence you earn at the start of your turn by an amount equal to the ability's persistent value, which enables the ability's persistent effect. All your active persistent abilities end at the end of the encounter.
...
You weave an elemental enchantment into your body that enhances your statistics. Choose one of the following enchantments. You can change your enchantment and ward by performing a complex ritual as a respite activity. *(Quick Build: Enchantment of Destruction.)*
...
You create an invisible elemental ward that protects you. Choose one of the following wards. You can change your ward and enchantment by performing a complex ritual as a respite activity. *(Quick Build: Ward of Surprising Reactivity.)*
...
| Animal Type | Level | Temp Stamina | Speed | Size | Stability Bonus | Melee Damage Bonus | Special |
|-------------|-------|-------------|-------|------|----------------|-------------------|---------|
| Canine | 2nd | 5 | 7 | 1M | +0 | +1/+1/+1 | Edge on smell tests |
| Fish | 2nd | 0 | 5 (swim only) | 1T | +0 | +0/+0/+0 | Breathe in water, can't breathe outside |
| Rodent | 2nd | 0 | 5 (climb) | 1T | +0 | +0/+0/+0 | Edge on smell tests |
| Bird | 3rd | 0 | 5 (fly) | 1T | +0 | +0/+0/+0 | -- |
| Great cat | 3rd | 5 | 6 (climb) | 2 | +0 | +1/+1/+1 | Jump 3 squares; prone + free strike on landing |
| Giant frog | 4th | 5 | 5 (swim) | 2 | +0 | +0/+0/+0 | Melee free strike distance 3; jump half speed |
| Horse | 4th | 5 | 8 | 2 | +1 | +0/+0/+0 | Charge as maneuver (no two Charges same turn) |
| Mohler | 4th | 0 | 7 (burrow) | 1S | +1 | +0/+0/+0 | Melee free strike +1 bonus |
| Bear | 5th | 10 | 5 (climb) | 2 | +1 | +2/+2/+2 | Melee free strike +1 bonus |
| Giant bird | 5th | 0 | 7 (fly) | 2 | +0 | +1/+1/+1 | Shift 3 squares after melee free strike |
| Giant salamander | 6th | 5 | 5 | 1L | +3 | +2/+2/+2 | Fire free strike; fire immunity 3 |
| Giant spider | 6th | 0 | 5 (climb) | 2 | +0 | +0/+1/+2 | Double edge on melee free strikes vs hidden |
| Giant snake | 7th | 5 | 5 | 3 | +0 | +0/+1/+2 | Auto grab on tier 2/3; 2 damage/turn while grabbed |
| Kangaroo | 7th | 0 | 7 | 1L | +1 | +0/+0/+4 | Crit = dazed; jump half speed |
| Spiny armadillo | 7th | 10 | 5 | 1M | +2 | +0/+0/+0 | Adjacent attackers take 3 damage |
| Ostrich | 8th | 0 | 10 | 2 | +0 | +1/+1/+1 | No opportunity attacks |
| Shark | 8th | 0 | 8 (swim only) | 2 | +0 | +2/+2/+2 | Breathe in water; edge on bleeding/winded targets |
| Giant octopus | 9th | 5 | 5 (swim) | 3 | +2 | +0/+0/+0 | 2 targets; auto grab; up to 8 grabbed |
| Rhinoceros | 9th | 10 | 8 | 2 | +5 | +2/+2/+2 | Charge free strike gains an edge |
| King terror lizard | 10th | 20 | 5 | 4 | +3 | +2/+2/+2 | Melee free strike is 1 burst with Area and Strike |
...
#### There Is No Space Between
*Knowledge of the mystery reveals that two spaces are the same place.*
- **Keywords**: Magic, Ranged, Void
- **Type**: Maneuver
- **Distance**: Ranged 10
- **Target**: Special
...
- **Distance**: Ranged 10
- **Target**: Self or one ally
- **Effect**: The target is teleported to another empty space within distance. Make a power roll that affects each enemy adjacent to the target's new space.
- **Power Roll + Reason**:
  - <=11: 3 fire damage
  - 12-16: 5 fire damage
  - 17+: 8 fire damage
...
- **Burning Grounds**: At the end of each of your turns, each enemy in the area takes fire damage equal to your Reason score.
- **Flowering Bed**: At the end of each of your turns, each ally in the area gains temporary Stamina equal to your Reason score.
- **Quaking Earth**: At the end of each of your turns, you can push each enemy in the area up to a number of squares equal to your Reason score.
- **Veiling Bed**: The area provides concealment for you and your allies.
...
- You create a seal on a surface that can't be seen or felt by anyone but you. When a creature comes adjacent to the surface, you can see and hear through the seal for as long as the creature remains adjacent to it. When you create the seal, you can decide to limit the number of creatures who activate it by choosing a creature keyword, a specific name, or organizational affiliation. If you create a second seal, the first one disappears. You can dispel a seal at any time (no action required).

### New 9-Essence Ability

Choose one heroic ability from the following options, each of which costs 9 essence to use. Alternatively, you can choose one of the 9-essence abilities you didn't select at 5th level.
...
- **Keywords**: Earth, Fire, Magic, Ranged, Void
- **Type**: Main action
- **Distance**: Ranged 10
- **Target**: One creature or object
- **Power Roll + Reason**:
...
Additionally, whenever you use your Disciple of the Green feature, you can select an additional animal form and gain the positive benefits from both forms. You can choose the size of either animal, and if both animal forms grant the same benefit, you can choose whichever you prefer. You gain the highest speed between the two animal forms and have all types of movement from both forms.
...
**Source of Earth** -- Level 8 Brute (Elemental):
- Size 2, Speed 6, Stamina 45, Stability 5, Free Strike 5
- Might +3, Agility +1, Reason -5, Intuition -5, Presence -3
- Movement: Burrow
- **Earthwalk**: Difficult terrain composed of earth and stone doesn't cost the source extra movement.
- **Tunneler**: When the source burrows, they create a size 2 tunnel.
- **Earth Harness**: A creature that has the Earth Accepts Me ability can use it as a free action to meld into the source.
- **Boulder Bash** (Signature Ability): Melee, Ranged, Strike, Weapon. Melee 2 or ranged 10. One creature or object.
  - <=11: 5 damage; push 3
...
- **Target**: Each enemy in the area
- **Power Roll + Reason**:
  - <=11: 7 fire damage; the Director loses 2 Malice
...
- **Distance**: Ranged 10
- **Target**: Special
- **Effect**: You create a size 1L vortex that lasts until the end of the encounter. At the start of each combat round while the vortex is unoccupied, the vortex vertical pulls 3 each enemy within 5 squares of it. Any enemy who enters the vortex or starts their turn there is knocked prone. At the end of the round, if a winded enemy is in the vortex, and that enemy is not a leader or solo creature, they are instantly destroyed.
...
Choose one heroic ability from the following options, each of which costs 11 essence to use. Alternatively, you can choose one of the 11-essence abilities you didn't select at 8th level.
...
- **Starting Characteristics:** Might 2, Agility 2, plus one of the following arrays for remaining scores:
  - 2, -1, -1
  - 1, 1, -1
  - 1, 0, 0
...
- **Stamina Gained at 2nd and Higher Levels:** 9
- **Recoveries:** 10
- **Skills:** You gain the Nature skill. Then choose any two skills from the exploration or intrigue skill groups. *(Quick Build: Alertness, Jump, Nature.)*
...
You can use and gain the benefits of a kit. *(Quick Build: Panther.)*
...
The fury (Berserker and Reaver aspects) uses a kit like other classes. The Stormwight aspect instead uses the Stormwight Kits subsystem (see below), which replaces the normal kit with a beast-form kit that provides its own bonuses and signature ability.
...
Your primordial aspect grants a feature, as shown on the 2nd-Level Aspect Features table.
...
- **Target:** One creature
- **Power Roll + Might:**
  - <=11: 4 + M damage; I < WEAK, slowed (save ends)
...
- **Power Roll + Might:**
  ...
  - 12-16: 18 + M damage
  - 17+: 24 + M damage
- **Effect:** Each enemy within 5 squares of you is distracted until end of the round. While a creature is distracted this way, they can't take triggered actions or free triggered actions, ability rolls made against them gain an edge, and their characteristic scores are considered 1 lower for the purpose of resisting potencies.
...
The stormwight primordial aspect lets you channel your ferocity into the form of an animal and grants you knowledge of one stormwight kit of your choice. You can master additional stormwight kits through play, changing them out during a respite as with any other kit.

#### Kit Features

All stormwight kits have the following features in common.

**Aspect Benefits and Animal Form:** Your primordial aspect benefits are always available to you, and you gain additional benefits while in the animal or hybrid form granted by your stormwight kit.

**Aspect of the Wild:** You have the following ability.
...
**Primordial Storm:** Each stormwight kit is associated with a primordial storm, which channels a specific damage type used by some of your abilities.

**Equipment:** You wear no armor and wield only your unarmed strikes -- which become devastating natural weapons as your ferocity grows.

**Kit Bonuses:** These bonuses apply in your true form, your animal form, and your hybrid form.

**Signature Ability:** You gain a new signature ability from your kit.

**Growing Ferocity:** Each stormwight kit grants a set of benefits for your Growing Ferocity feature.
...
**Aspect Benefits:** Whenever you use forced movement to push a creature, you can pull that creature instead. Whenever you pull a creature adjacent to you and that creature has M < AVERAGE, you can use a free triggered action to make that creature grabbed by you.

**Animal Form: Bear:** While in your bear form, your size is 2 and you gain a +1 bonus to distance with melee weapon abilities.

**Hybrid Form: Bear:** While in your hybrid form, your size is 2 and you gain a +1 bonus to distance with melee weapon abilities. At 4th level, the first time you take hybrid form in an encounter, you gain 10 temporary Stamina.
...
**Aspect Benefits:** You gain an edge on tests made to hide and sneak. Additionally, whenever you fall, you can use a free triggered action to use your Aspect of the Wild ability.

**Animal Form: Crow:** While in your crow form, your size is 1T and you can fly. You can use the Hide maneuver as a free maneuver, and you can use your allies as cover when you hide. You can't use any abilities while in this form except for Aspect of the Wild.

**Hybrid Form: Crow:** While in your hybrid form, your size is your choice of 1S or 1M. At 4th level, you can fly.
...
**Animal Form: Rat:** While in your rat form, your size is 1T and you can automatically climb at full speed while moving. You can use the Hide maneuver as a free maneuver, you can use your allies as cover when you hide, and you can stay hidden while you move through squares occupied by any creature. Additionally, you gain an edge on tests made to climb while in this form. You can't use any abilities while in this form except for Aspect of the Wild.

**Hybrid Form: Rat:** While in your hybrid form, your size is your choice of 1S or 1M. At 4th level, you can automatically climb at full speed while moving.
...
##### Signature Ability: Driving Pounce
...
**Animal Form: Wolf:** While in your wolf form, your size is 1L, you have a +2 bonus to speed, and you ignore difficult terrain.

**Hybrid Form: Wolf:** While in your hybrid form, your size is 1L, you have a +2 bonus to speed, and you ignore difficult terrain. At 4th level, the first time you take hybrid form in an encounter, you gain 10 temporary Stamina.
...
##### Signature Ability: Unbalancing Attack
...
| 4 | The first time in a turn that you grab a creature or an enemy moves 1 or more squares in the area of your Null Field ability, you gain 1 surge. |
| 6 | You gain an edge on the Grab and Knockback maneuvers. |
| 8 (4th level) | The first time in a turn that you grab a creature or an enemy moves 1 or more squares in the area of your Null Field ability, you gain 2 surges. |
| 10 (7th level) | You have a double edge on the Grab and Knockback maneuvers. |
| 12 (10th level) | Whenever you force move a target, the forced movement distance gains a bonus equal to your Intuition score. Additionally, whenever you use a heroic ability, you gain 10 temporary Stamina. |
...
- **Density Augmentation:** You gain a +6 bonus to Stamina, and this bonus increases by 6 at 4th, 7th, and 10th levels. Additionally, you gain a +1 bonus to stability.
...
#### Phase Inversion Strike (3 Discipline)
...
- **Effect**: While weakened this way, the target takes damage equal to your Intuition score whenever they use a supernatural ability or whenever they use an ability that costs Malice.
...
When you gain discipline at the start of your turns during combat, you gain 3 discipline instead of 2.
...
When you gain discipline at the start of your turns during combat, you gain 4 discipline instead of 3.
...
- **Stamina Gained at 2nd and Higher Levels**: 6
- **Recoveries**: 8
- **Skills**: You gain the Hide and Sneak skills. Then choose any five skills from Criminal Underworld or the skills of the exploration, interpersonal, or intrigue skill groups. (*Quick Build*: Criminal Underworld, Hide, Lie, Pick Lock, Pick Pocket, Sabotage, Sneak.)
...
**Effect**: You shift up to your speed and make one power roll that targets up to three enemies who came adjacent to you during your move.
...
*(See 7-Insight Ability section above for all options.)*
...
*(See 9-Insight Ability section above for all options.)*
...
- Enemies' spaces don't count as difficult terrain for you. An enemy takes corruption damage equal to your Agility score the first time you pass through their space on your turn.
...
*(See 11-Insight Ability section above for all options.)*
...
| 4th | Characteristic Increase, Focus on Their Weaknesses, Improved Field Arsenal, Perk, Skill | 3, 5, 7 | 5 |
...
While in your presence or working according to your plans, each of your allies gains an edge on tests using any skill from the intrigue skill group. Additionally, you can use the Lead skill to assist another creature with any test made using a skill from the intrigue skill group.
...
**Effect:** You shift up to your speed directly toward an ally, ending adjacent to them, then swapping locations with that ally as long as you can fit each other's spaces. The ally can spend a Recovery, and you can make the following weapon strike with a distance of melee 1 against a creature.
- **Power Roll + Reason:**
...
*(See 9-Focus Ability section above for full details.)*
...
*(See 11-Focus Ability section above for full details.)*
...
**Effect:** Each target can make a ranged free strike that gains an edge against any enemy marked by you within distance of their ranged free strike. A target ignores banes and double banes when making this free strike.
...
*(See 9th-Level Mastermind Abilities above for full details.)*
...
- **Stamina Gained at 2nd and Higher Levels:** 6
- **Recoveries:** 8
- **Skills:** You gain the Psionics and Read Person skills. Then choose any two skills from the interpersonal or lore skill groups. (*Quick Build:* Empathize, Psionics, Read Person, Timescape.)
...
You know the Mindspeech language. Additionally, you can telepathically communicate with any creatures within distance of your Mind Spike ability if they share a language with you and you know of each other. When you communicate with someone this way, they can respond telepathically.
...
- **Distance:** Ranged 10
- **Target:** Self or one ally
- **Effect:** Until the start of your next turn, the target has cold immunity 10 and fire immunity 10, and their strikes deal extra fire damage equal to twice your Reason score. Additionally, whenever an enemy attempts to use a melee ability against the target while they are under this effect, the enemy takes 5 fire damage.
...
#### 2nd-Level Chronopathy Abilities
...
- **Effect:** A target can't use triggered actions while its speed is reduced this way.
...
#### 2nd-Level Telekinesis Abilities
...
- **Keywords:** Psionic, Melee, Strike, Telepathy
- **Type:** Main action
- **Distance:** Melee 2
- **Target:** One creature
- **Power Roll + Reason:**
...
- **Strained:** While the target is under this effect, you no longer consider enemies to be your enemies when using your abilities and features.
...
- **Starting Characteristics:** You start with an Agility of 2 and a Presence of 2, and you can choose one of the following arrays for your four other characteristic scores:
  - 2, -1, -1
  - 1, 1, -1
  - 1, 0, 0
- **Weak Potency:** Presence - 2
...
| 7th | Characteristic Increase, A Muse's Muse, Equal Billing, Skill | Signature, 3, 5, 7, 9 | 5, 9 |
| 8th | Perk, Class Act Feature, 11-Drama Ability | Signature, 3, 5, 7, 9, 11 | 5, 9 |
...
- **Distance:** Ranged 10
- **Target:** One creature
- **Trigger:** The target makes an ability roll that has an edge, a bane, a double edge, or a double bane.
...
- **Effect:** The first time the target uses an ability before the start of your next turn, any tier outcomes from the ability's tier outcomes other than damage are negated for all targets. Ability effects that always happen regardless of the power roll work as usual.
...
- **Target:** Special
- **Power Roll + Presence:**
  - 11 or lower: One ally within distance can take their turn immediately after yours.
...
- **Target:** Each enemy in the area
- **Power Roll + Presence:**
  - 11 or lower: 6 damage; P < WEAK, the target can't willingly leave the area (EoT)
...
##### "Never-Ending Hero"
*And toniight we can truly say? They will alllways find a way!*
- **Keywords:** Area, Magic, Performance
- **Type:** No action
- **Distance:** 5 aura
- **Target:** Self and each ally in the area
- **Effect:** While this performance is active, each target who starts their turn in the area gains an edge on power rolls and ignores the effects of bleeding until the end of their turn.
...
- 11 or lower: Your information reaches no one.
...
Once on each of your turns, you can use a free maneuver to change one condition affecting a creature within distance of your Dramatic Monologue ability. Choose one of the following conditions on the target: bleeding, frightened, prone, slowed, or taunted. You change that condition to another of those conditions, maintaining the duration and origin of the original condition. A target who is no longer prone can stand.
...
Once on each of your turns while the target of your Foil feature is adjacent to you, you can use a free maneuver to exchange words with the target. Make an opposed Presence test with the target. Whoever gets the higher result can make a free strike, which deals psychic damage instead of its usual damage.
...
- **Distance:** 5 aura
- **Target:** Self and each ally in the area
- **Effect:** While this performance is active, each target who starts their turn in the area gains 1 Heroic Resource. This Heroic Resource disappears at the end of the target's turn if they don't spend it.
...
Choose one of your signature abilities and name it after yourself. You always have this ability available, even if it is sourced from a kit you switch out. Whenever you use this ability, you gain an edge and 1 surge that you can only use on this ability.
...
##### Radical Fantasia
*Viras, my Viras, will you hold their hands as they cryyy-aaaligh?*
- **Keywords:** Area, Magic, Performance
- **Type:** No action
- **Distance:** 5 aura
- **Target:** Self and each ally in the area
...
- **Target:** One creature
- **Power Roll + Presence:**
  - 11 or lower: The target takes a bane on ability rolls (save ends).
...
You gain 1 additional drama or other Heroic Resource whenever you use your Appeal to the Muses feature. Additionally, your performances no longer have a distance. Additionally, your performances can affect any target on the encounter map within your line of effect.
