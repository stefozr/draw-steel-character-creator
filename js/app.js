...
DS.App = (function() {
  ...
  function showLevelUp(charId) {
    ...
    container.style.setProperty('--step-bg', "url('../resources/images/classes/" + clsName + ".png')");
  ...
  function showCharacterSheet() {
    ...
    if (char && char.class && char.class.id) {
      ...
      summaryEl.style.setProperty('--step-bg', "url('../resources/images/classes/" + className + ".png')");
    } else {
